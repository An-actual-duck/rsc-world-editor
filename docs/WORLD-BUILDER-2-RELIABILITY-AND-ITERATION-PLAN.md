...
### Candidate delivery checkpoint — 2026-09-06
...
finish guarded runtime upgrade and separate map-only activation with the actual
launcher/UI; then run complete disposable-target and packaged candidate
acceptance. Existing successful component proofs do not need redesign or repeated
